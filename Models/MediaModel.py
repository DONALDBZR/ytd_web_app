...
class Media(Table_Model):
    def __init__(
        ...
        **kwargs
        ...
        """
        Initializing a new Media model instance.

        This constructor passes the database handler and any additional keyword arguments to the parent `Table_Model`, specifically setting the table name to "Media".
    ...
    def getMetadata(
        ...
        Returns:
            List[Media]: A list of Media instances containing the fetched metadata.
        """
