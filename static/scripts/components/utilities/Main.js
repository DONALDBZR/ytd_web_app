...
class Main extends Application {
     ...
     * @returns {void}
     */
    retrieveMedia(event, media_uniform_resource_locator, tracker) {
        event.preventDefault();
        ...
        try {
            ...
            this.downloadMedia(platform, type, identifier, 200, tracker);
        } catch (error) {
    ...
    manageResponse(response, delay) {
        try {
            ...
            setTimeout(() => this.redirect(response.uniform_resource_locator), delay);
        } catch (error) {
